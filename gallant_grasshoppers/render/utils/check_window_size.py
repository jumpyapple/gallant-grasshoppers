...
def check_window_size() -> None:
    ...
    if term.height < 20 or term.width < 80:
        while True:
            with term.fullscreen(), term.cbreak(), term.hidden_cursor(), term.location(y=term.height // 2):
                print(term.black_on_rosybrown(term.center("Please adjust your terminal to at least 80 x 20")))
